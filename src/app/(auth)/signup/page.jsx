...
export const metadata = {
  title: "Create an Account | SkillBridge",
  description:
    "Create your SkillBridge account to start your learning journey, access academies, and unlock global opportunities.",
};
    ...
    <div className="flex min-h-screen flex-col lg:flex-row">
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="max-w-md text-base leading-relaxed text-white/70">
              Create an account to start your learning journey, access your academies,
      ...
      <div className="flex w-full flex-col bg-surface px-6 py-10 sm:px-10 lg:w-1/2 lg:px-14 lg:py-12">
        <div className="flex items-center justify-end gap-4">
          <span className="text-sm text-body">Already have an account?</span>
          <Button href={loginHref} variant="brand-light" className="border-brand/40 px-4 py-2">
            Log In
          </Button>
        </div>
        ...
        <div className="flex flex-1 items-center justify-center py-10">
          <div className="flex w-full max-w-md flex-col gap-6">
            <Suspense
              fallback={
                <div className="h-[640px] w-full animate-pulse rounded-2xl border border-border bg-white" />
              }
            >
              <SignupForm />
            </Suspense>
